    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,""D:\!!PROJECTS\Attendance Management System using Face Recognition\Attendance\Manually Attendance\OOP_2019_02_22_Time_11_32_41.csv"\-------Check atttendance-------"')
